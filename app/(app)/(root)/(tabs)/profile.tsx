  ...
  return (
    <Center className="mb-[56px] mt-[16px]">
      <Box className="mb-[12px]">
        <Avatar size="2xl">
          {!!avatar ? <Image style={{ width: '100%', height: '100%', borderRadius: 1000 }} contentFit="contain" source={{ uri: `${process.env.EXPO_PUBLIC_SUPABASE_URL}/storage/v1/object/public/profile/${avatar}` }} /> : <AvatarFallbackText>{name}</AvatarFallbackText>}
        </Avatar>
        <Button
          action="default"
