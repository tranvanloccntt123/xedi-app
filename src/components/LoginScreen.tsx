    ...
    <View className="flex-1 justify-center items-center bg-gray-100">
      ...
      >
        <VStack space="md">
          ...
          <Button onPress={handleLogin} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
          ...
          <Button 
            ...
            className="mt-4 border border-blue-500 text-blue-500 font-bold py-2 px-4 rounded"
          >
