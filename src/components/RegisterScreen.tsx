  ...
  return (
    <Box className="flex-1 justify-center p-6 bg-gray-100">
      <VStack space="md" className="bg-white p-8 rounded-lg shadow-md items-center justify-center">
        ...
        >
          <SelectTrigger variant="outline" size="md" className="w-full mb-4 p-3 border border-gray-300 rounded-md">
        ...
        <Button variant="outline" onPress={() => navigation.navigate(RouteName.Login)} className="w-full mt-4 border border-blue-500 py-3 rounded-md">
